            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h2 style="font-size: 36px; font-weight: bold; font-family: 'Times New Roman', Times, serif; margin: 0;">
                        ...
                        <span style="color: #FFD800;">Ball-a-thon</span> <span style="color: #393186;"> Attractions</span>
                    </h2>
                    {{-- </li>
                    </ul> --}}
                </div>
                                                    ...
                                                    class="unit unit-spacing-md align-items-center d-block d-md-flex"><span
                                                        class="unit-left"><span class="schedule-classic-img"><img
                                                            ...
                                                            <span class="schedule-classic-title heading-4"
                                                                style="font-family:Arial;font-size: 28px;">EXCLUSIVE GALA
                                                                DINNER</span>
                                                        </span></span></span></span>
                                        </div>
                                        <div class="collapsed col-lg-6" id="accordion1-card-head-hxapwahb"
                                            ...
                                            <span class="schedule-classic"><span class=""><span
                                                        ...
                                                        class="unit-body"><span class="schedule-classic-content">
                                                            ...
                                                            <span class="schedule-classic-title heading-4"
                                                                style="font-family:Arial;font-size: 25px;">Dine with JITO
                                                                Apex dignitaries and influential business leaders.</span>
                                                        </span></span></span></span>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <span class="schedule-classic"><span
                                                    class="unit unit-spacing-md align-items-center d-block d-md-flex"><span
                                                        class="unit-left"><span class="schedule-classic-img"><img
                                                            ...
                                                            <span class="schedule-classic-title heading-4"
                                                                style="font-family:Arial;font-size: 28px;">2 DAY GRAND
                                                                CARNIVAL WITH CLOSING CEREMONY</span>
                                                        </span></span></span></span>
                                        </div>
                                        <div class="collapsed col-lg-6" id="accordion1-card-head-hxapwahb"
                                            data-toggle="collapse" data-parent="#accordion1"
                                            ...
                                            <span class="schedule-classic"><span class=""><span
                                                        ...
                                                        class="unit-body"><span class="schedule-classic-content">
                                                            ...
                                                            <span class="schedule-classic-title heading-4"
                                                                style="font-family:Arial;font-size: 25px;">Expected overall
                                                                footfall of 25,000+</span>
                                                        </span></span></span></span>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <span class="schedule-classic"><span
                                                    class="unit unit-spacing-md align-items-center d-block d-md-flex"><span
                                                        ...
                                                        class="unit-body"><span class="schedule-classic-content">
                                                            ...
                                                            <span class="schedule-classic-title heading-4"
                                                                style="font-family:Arial;font-size: 28px;">SPECIAL
                                                                EXHIBITION MATCH</span>
                                                        </span></span></span></span>
                                        </div>
                                        <div class="collapsed col-lg-6" id="accordion1-card-head-hxapwahb"
                                            data-toggle="collapse" data-parent="#accordion1"
                                            ...
                                            <span class="schedule-classic"><span class=""><span
                                                        ...
                                                        class="unit-body"><span class="schedule-classic-content">
                                                            ...
                                                            <span class="schedule-classic-title heading-4"
                                                                style="font-family:Arial;font-size: 25px;">Sponsor Team vs
                                                                JITO Dignitaries – A fun, bonding experience!</span>
                                                        </span></span></span></span>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <span class="schedule-classic"><span
                                                    class="unit unit-spacing-md align-items-center d-block d-md-flex"><span
                                                        ...
                                                        class="unit-body"><span class="schedule-classic-content">
                                                            ...
                                                            <span class="schedule-classic-title heading-4"
                                                                style="font-family:Arial;font-size: 28px;">VIDEO
                                                                BYTES</span>
                                                        </span></span></span></span>
                                        </div>
                                        <div class="collapsed col-lg-6" id="accordion1-card-head-hxapwahb"
                                            ...
                                            <span class="schedule-classic"><span class=""><span
                                                        ...
                                                        class="unit-body"><span class="schedule-classic-content">
                                                            ...
                                                            <span class="schedule-classic-title heading-4"
                                                                style="font-family:Arial;font-size: 25px;">Personalized
                                                                event highlights to be circulated nationally.</span>
                                                        </span></span></span></span>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <span class="schedule-classic"><span
                                                    class="unit unit-spacing-md align-items-center d-block d-md-flex"><span
                                                        ...
                                                        class="unit-body"><span class="schedule-classic-content">
                                                            ...
                                                            <span class="schedule-classic-title heading-4"
                                                                style="font-family:Arial;font-size: 28px;">CELEBRITY
                                                                INTERACTIONS</span>
                                                        </span></span></span></span>
                                        </div>
                                        <div class="collapsed col-lg-6" id="accordion1-card-head-hxapwahb"
                                            ...
                                            <span class="schedule-classic"><span class=""><span
                                                        ...
                                                        class="unit-body"><span class="schedule-classic-content">
                                                            ...
                                                            <span class="schedule-classic-title heading-4"
                                                                style="font-family:Arial font-size: 25px;">Photos &
                                                                Felicitations with Celebrities.</span>
                                                        </span></span></span></span>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <span class="schedule-classic"><span
                                                    class="unit unit-spacing-md align-items-center d-block d-md-flex"><span
                                                        ...
                                                        class="unit-body"><span class="schedule-classic-content">
                                                            ...
                                                            <span class="schedule-classic-title heading-4"
                                                                style="font-family:Arial;font-size: 28px;">UNIQUE
                                                                NETWORKING</span>
                                                        </span></span></span></span>
                                        </div>
                                        <div class="collapsed col-lg-6" id="accordion1-card-head-hxapwahb"
                                            ...
                                            <span class="schedule-classic"><span class=""><span
                                                        ...
                                                        class="unit-body"><span class="schedule-classic-content">
                                                            ...
                                                            <span class="schedule-classic-title heading-4"
                                                                style="font-family:Arial;font-size: 25px;">Connect with
                                                                stalwarts of JITO and leaders from various
                                                                industries.</span>
                                                        </span></span></span></span>
                                        </div>
                                    </div>
                                            ...
                                            <span class="schedule-classic"><span
                                                    class="unit unit-spacing-md align-items-center d-block d-md-flex"><span
                                                        ...
                                                        class="unit-body"><span class="schedule-classic-content">
                                                            ...
                                                            <span class="schedule-classic-title heading-4"
                                                                style="font-family:Arial;font-size: 28px;">RECOGNITION AT
                                                                APEX LEVEL</span>
                                                        </span></span></span></span>
                                        </div>
                                        <div class="collapsed col-lg-6" id="accordion1-card-head-hxapwahb"
                                            ...
                                            <span class="schedule-classic"><span class=""><span
                                                        ...
                                                        class="unit-body"><span class="schedule-classic-content">
                                                            ...
                                                            <span class="schedule-classic-title heading-4"
                                                                style="font-family:Arial;font-size: 25px;">Special
                                                                acknowledgment for sponsors at all JITO Apex forums.</span>
                                                        </span></span></span></span>
                                        </div>
                                    </div>
                                </div>
