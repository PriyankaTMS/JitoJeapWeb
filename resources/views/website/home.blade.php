...
@section('content')
    <section>
        <!-- Image -->
        <div class="desktop-margin" style="position: relative;">
        ...
        <div id="cardContainer"
            ...
            <!-- Card 2 -->
            <a href="{{ route('completed.event') }}" style="text-decoration: none;">
                <div style="background-color: #fff; padding: 20px; border-radius: 10px; box-shadow: 0 8px 20px rgba(0,0,0,0.2); width: 200px; transition: 0.3s ease; cursor: pointer; text-align: center;"
            ...
            <div style="background-color: #fff; padding: 20px; border-radius: 10px; box-shadow: 0 8px 20px rgba(0,0,0,0.2); width: 200px; transition: 0.3s ease; cursor: pointer; text-align: center;"
                ...
                <i class="ri-user-voice-line icon" style="font-size: 32px; color: #000;"></i>
            ...
            <div style="background-color: #fff; padding: 20px; border-radius: 10px; box-shadow: 0 8px 20px rgba(0,0,0,0.2); width: 200px; transition: 0.3s ease; cursor: pointer; text-align: center;"
                ...
                <i class="mdi mdi-eye-outline icon" style="font-size: 32px; color: #000;"></i>
