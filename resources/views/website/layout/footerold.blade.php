    ...
    <div class="container" style=" margin-bottom: -70px;">
        <div class="row row-30">
            ...
            <div class="col-xs-10 col-sm-6 col-lg-4">
                <h5 style="font-family: Times New Roman !important"><span class="big font-weight-sbold">Event
                        detail</span></h5>
                <div>
                    <p
                        style="margin-top:20px; margin-bottom:20px;font-family: Arial;color: #fff;font-size: 18px;font-weight: 400;">
                        {{-- <time data-splitting datetime="2025-9-25">25 September 2025</time> --}}
                        <span> Date :- 25 September 2025</span>
                    </p>
                    <p class="event-detail-address big"
                        style="font-family: Arial;color: #fff;font-size: 18px;font-weight: 400;">Hotel Treat, Govind
                        Nagar,
                        Nashik, Maharashtra.
