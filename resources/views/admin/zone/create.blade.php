...
@section('container')
    <div class="page-wrapper">
        ...
        <div class="card" style="margin: 10px;">
            <form class="form-horizontal" method="post" action="{{ route('admin.zone.store') }}"
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <label for="desc" class="form-label">Description <span class="text text-danger">*</span></label>
