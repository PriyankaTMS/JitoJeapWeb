...
@section('container')
    <div class="page-wrapper">
        ...
        <div class="card" style="margin: 10px;">
            <form class="form-horizontal" method="post" action="{{ route('admin.zone.update', $powteam->id) }}"
                ...
                <div class="card-body">
                    ...
                    @if ($powteam->logo)
                        <div class="mt-2">
                            ...
                            <img src="{{ asset('zone/' . $powteam->logo) }}" alt="Current Logo" class="img-fluid"
