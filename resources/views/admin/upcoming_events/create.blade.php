...
@section('container')
    <div class="page-wrapper">
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-12 d-flex no-block align-items-center">
                    <h4 class="page-title">Add Upcoming Event</h4>
                    <div class="ms-auto text-end">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('admin.upcoming') }}">completed Event</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="card">
            <form class="form-horizontal" method="post" action="{{ route('admin.upcoming.store') }}"
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="place" placeholder="Enter Place" class="form-control" id="place"
                            style="font-size:14px;color: #95949E;" required>
                    </div>
                    {{-- <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description" id="description" rows="4" placeholder="Enter Description" class="form-control"
                            style="font-size:14px; color: #95949E;" required></textarea>
                    </div>
