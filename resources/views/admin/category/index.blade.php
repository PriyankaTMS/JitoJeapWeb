                    ...
                    <tbody class="customtable">
                        @foreach ($categories as $list)
                            <tr>
                                ...
                                <td>
                                    <a href=" {{ route('admin.category.edit', $list->id) }}"><button type="button"
                                            class="btn btn-success">Edit</button></a>

                                    <a href="{{ route('admin.category.delete', $list->id) }}"><button type="button"
