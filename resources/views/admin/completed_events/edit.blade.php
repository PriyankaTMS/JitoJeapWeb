...
@section('container')
    <div class="page-wrapper">
        ...
        <div class="card">
            <form class="form-horizontal" method="post" action="{{ route('admin.completed.update', $completed->id) }}"
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" value="{{ $completed->title }}" placeholder="Enter Title"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="place" placeholder="Enter Place" value="{{ $completed->place }}"
                            class="form-control" id="place" style="font-size:14px;color: #95949E;" required>
                    </div>
                    {{-- <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <img src="{{ asset('Completed/' . $completed->image) }}" alt="Current Logo" class="img-fluid"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description" id="description" rows="4" placeholder="Enter Description" class="form-control"
                            style="font-size:14px; color: #95949E;" required>{{ $completed->description }}</textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="date" id="date" value="{{ $completed->date }}"
