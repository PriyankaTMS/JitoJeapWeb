                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="place" placeholder="Enter Place"
                            value="{{ $completed->place }}" class="form-control" id="place"
                    ...
                    <div class="mb-3">
                        ...
                        <img src="{{ asset('completeds/' . $completed->image) }}" alt="Current Logo" class="img-fluid"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description" id="description" rows="4" placeholder="Enter Description"
                            class="form-control" style="font-size:14px; color: #95949E;" required>{{ $completed->description }}</textarea>
                    </div>
